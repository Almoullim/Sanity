...
class VolunteerEditProfileViewController: UITableViewController, UIImagePickerControllerDelegate, UINavigationControllerDelegate {
            ...
            db.collection("users").whereField("uid", isEqualTo: currentUser.uid)
                .getDocuments() { (querySnapshot, err) in
                    ...
                    if let data = querySnapshot?.documents[0].data() {
                        ...
                        self.issueInput.text = data["speciality"] as? String
    ...
    @IBAction func saveButtonClicked(_ sender: UIBarButtonItem) {
        ...
        let docData: [String: Any] = [
            ...
            "speciality":self.issueInput.text!,
